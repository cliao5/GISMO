...
# Some hardcoding for simplicity
...
sumstatPrefix="/home/rye/toga-human_hg38_reference/partitioned-heritability/inputs/sumstats/ukb31063_ldsc/sumstats"
...
parallel -j 15 gwas "${sumstatPrefix}" "${d}" "${weights}" "${frqfile}" ::: "${traitList[@]}" > "${name}"_log
